...
RUN echo 'export DISPLAY=:0' > /home/user/kiosk.sh && \
    ...
    #echo 'unzip kiosk.zip && sleep 3 && /usr/bin/browserk --load-extension=/home/user/kiosk/ $WEBPAGE &' >> /home/user/kiosk.sh && \
    echo 'unzip kiosk.zip && unzip browser.zip && sleep 5 && /usr/bin/browserk $WEBPAGE &' >> /home/user/kiosk.sh && \
...
COPY Files/browser.zip /usr/bin/
